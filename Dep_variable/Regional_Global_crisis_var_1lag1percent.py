...
Data1 = pd.read_csv(r"D:\Data\Grad\1lag_crisis.csv") # Crisis Variable.
...
for j in range(len(Data1)):
    if sum(list(Data1.loc[j, [i for i in countries_asia_dat]])) >= int(len(countries_asia_dat)/2):
...
global_regional_df = global_regional_df.fillna(0)
...
global_regional_df.to_csv(r"D:\Data\Grad\1global_regional1p.csv")
